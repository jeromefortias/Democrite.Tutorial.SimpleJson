    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var jsonProcessSeq = Sequence.Build("JFO", fixUid: new Guid("D1F7C7EB-77F7-488A-91D7-77E4D5D16448"), metadataBuilder: m =>
                                         ...
                                         .Build();
            var jsonProcessSeq2 = Sequence.Build("JFO", fixUid: new Guid("D1F7C7EB-77F7-488A-91D7-77E4D5D16448"), metadataBuilder: m =>
            {
                m.Description("Load, analyze and store the json result2")
                 .AddTags("Json", "ES");
            })
                                         .RequiredInput<string>()
                                         .Use<IJsonLoaderVGrain>().Call((g, i, ctx) => g.LoadJsonAsync(i, ctx)).Return
